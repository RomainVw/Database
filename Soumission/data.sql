...
ALTER TABLE ONLY DATERELATION
    ADD CONSTRAINT C24 FOREIGN KEY (DATEID) REFERENCES DATE(DATEID);

ALTER TABLE ONLY RANGERELATION
    ADD CONSTRAINT C25 FOREIGN KEY (START) REFERENCES DATE(DATEID);

ALTER TABLE ONLY RANGERELATION
    ADD CONSTRAINT C26 FOREIGN KEY (ENDDATE) REFERENCES DATE(DATEID);

ALTER TABLE ONLY BIRTH
    ADD CONSTRAINT C27 FOREIGN KEY (BIRTH) REFERENCES DATE(DATEID);

ALTER TABLE ONLY DEATH
    ADD CONSTRAINT C28 FOREIGN KEY (DEATH) REFERENCES DATE(DATEID);

ALTER TABLE ONLY EVENT
    ADD CONSTRAINT C29 FOREIGN KEY (BEGINNING) REFERENCES DATE(DATEID);

ALTER TABLE ONLY EVENT
    ADD CONSTRAINT C30 FOREIGN KEY (ENDDATE) REFERENCES DATE(DATEID);
...
INSERT INTO DATE VALUES ('DA1',28, 12, 1992);
INSERT INTO DATE VALUES ('DA2',1, 4, 1992);
INSERT INTO DATE VALUES ('DA3',3, 6, 1992);
INSERT INTO DATE VALUES ('DA4',9, 12, 2002);
INSERT INTO DATE VALUES ('DA5',13, 7, 2007);
INSERT INTO DATE VALUES ('DA6',10, 11, 2003);
INSERT INTO DATE VALUES ('DA7',12, 8, 2009);
INSERT INTO DATE VALUES ('DA8',10, 11, 2003);
INSERT INTO DATE VALUES ('DA9',12, 8, 2009);
INSERT INTO DATE VALUES ('DA10',28, 12, 1992);
INSERT INTO DATE VALUES ('DA11',8, 3, 2014);
INSERT INTO DATE VALUES ('DA12',18, 3, 2014);
INSERT INTO DATE VALUES ('DA13',15, 6, 2064);

INSERT INTO TIMELESSRELATION VALUES ('CH4','CH1', 'REL3');

INSERT INTO DATERELATION VALUES ('CH1','CH4', 'REL4', 'DA10');

INSERT INTO RANGERELATION VALUES ('CH1','CH3', 'REL1', 'DA4', 'DA5');
INSERT INTO RANGERELATION VALUES ('CH3','CH1', 'REL1', 'DA6', 'DA7');
INSERT INTO RANGERELATION VALUES ('CH2','CH3', 'REL2', 'DA8', 'DA9');

INSERT INTO BIRTH VALUES ('CH1','DA1');
INSERT INTO BIRTH VALUES ('CH2','DA2');
INSERT INTO BIRTH VALUES ('CH3','DA3');

INSERT INTO DEATH VALUES ('CH1','DA13');
...
INSERT INTO EVENT VALUES ('EV1', 'PL2', 'DA11', 'DA12');
